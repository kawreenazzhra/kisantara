  ...
  void _saveLanguage() async {
    ...
    if (user != null) {
      ...
      try {
        ...
        AppLocalizations.changeLanguage(_selectedLanguage);
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(
                '${AppLocalizations.translate('bahasa_diubah')} $_selectedLanguage!',
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(
                '${AppLocalizations.translate('gagal_ubah_bahasa')}: $e',
                style: GoogleFonts.plusJakartaSans(),
              ),
      ...
      builder: (context, currentLanguage, _) {
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text(
              AppLocalizations.translate('pilih_bahasa'),
              style: GoogleFonts.plusJakartaSans(
              ...
              : Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text(
                        AppLocalizations.translate('gunakan_bahasa_ini'),
                        style: GoogleFonts.plusJakartaSans(
                          fontWeight: FontWeight.w700,
                          fontSize: 16,
                        ),
