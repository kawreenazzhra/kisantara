...
class _WriteStoryScreenState extends State<WriteStoryScreen> {
  ...
  void _generateAICover() {
    ...
    final prompt = "indonesian folklore story about $title, category $_selectedCategory, digital art style, beautiful detailed fantasy illustration";
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Cover AI berhasil dibuat!', style: GoogleFonts.plusJakartaSans()),
        backgroundColor: const Color(0xFF00743B),
        behavior: SnackBarBehavior.floating,
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
      ),
